...
# fraud-laundering-mcp能力说明（macOS / Linux）
...
MCP_CONFIG='{"McpName":"fraud-laundering-mcp","McpURL":"http://lb-hcl91l4w-9x3l6p5id8zfs7h1.clb.nj-tencentclb.cloud/_llmsgw_/mcp/aga-6588cc10/mcp-280b0453"}' \
...
- 背债、房企信、企业信、征信包装专题用 `debt-runner-mcp`。
- 羊毛党、料商、四件套、泛黑灰产生态链用 `dark-grey-intel-mcp`。
